...
> [!NOTE]
> Trên bản SaaS, kênh cần gói Annual; nếu chưa có, trang hiển thị banner khoá và chủ workspace đăng ký trong [Hỗ trợ và thanh toán](/docs/console/support-and-billing). Bản SaaS không được cung cấp tại Việt Nam; tại Việt Nam, dewee chạy On-Premises và dùng license binding.
