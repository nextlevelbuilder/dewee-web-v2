...
> [!NOTE]
> On AaaS, channels need the Annual plan. Without it the page shows a locked banner; ask the workspace owner to subscribe in [Support and billing](/docs/console/support-and-billing). On Self-install, connecting channels needs a licence key that the owner activates in the console; see [Install dewee yourself](/docs/get-started/self-install).
