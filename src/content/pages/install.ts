  ...
  en: {
    ...
    steps: {
      ...
      items: [
        ...
        { title: "Get a licence key", body: "Agents, providers and skills work without one. To connect Zalo, Telegram, Discord, Slack and other channels, buy a licence for {price} a year for each workspace. With Early Access, the first year is {discounted} for the first {total} licences, until {date}." },
  ...
  vi: {
    ...
    steps: {
      ...
      items: [
        ...
        { title: "Mua license key", body: "Agent, nhà cung cấp và skill đều dùng được khi chưa có license. Để kết nối Zalo, Telegram, Discord, Slack và các kênh khác, bạn cần license {price} mỗi năm cho mỗi workspace. Với Early Access, năm đầu chỉ {discounted} cho {total} license đầu tiên, đến hết ngày {date}." },
